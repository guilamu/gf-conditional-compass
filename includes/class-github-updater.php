...
class GFCC_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'Gravity-Forms-Conditional-Compass';
     ...
     *
     * Prefers custom release assets (e.g., gf-conditional-compass.zip) over
    ...
    public static function plugin_info($res, $action, $args)
    {
        ...
        // IMPORTANT: Even if GitHub data is unavailable, return a proper response object
        // to prevent WordPress from falling back to WordPress.org API (which fails
        // with "Plugin not found" for custom/GitHub-hosted plugins)
        if (null === $release_data) {
